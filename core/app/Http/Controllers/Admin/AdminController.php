...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $seoInfo['totalService'] = Service::count();
        $seoInfo['totalSoftware'] = Software::count();
        $seoInfo['totalJob'] = Job::count();
        $seoInfo['totalAds'] = Advertise::count();
        $seoInfo['totalCategory'] = Category::count();
        $seoInfo['totalServiceBooking'] = Booking::whereNotNull('service_id')->where('status', '!=', 0)->count();
        $seoInfo['totalSalesSoftware'] = Booking::whereNotNull('software_id')->where('status', '!=', 0)->count();
        $seoInfo['totalHireEmploy'] = Booking::whereNotNull('job_biding_id')->where('status', '!=', 0)->count();
