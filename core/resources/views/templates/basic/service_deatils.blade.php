                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <div class="item-details-thumb">
                                                                        <img
                                                                            src="{{getImage('assets/images/service/'.$service->image, imagePath()['service']['size']) }}"
                                                            ...
                                                            <div class="right mb-20">
                                                                <div class="social-area">
                                                                    <ul class="footer-social">
                                                                        <li>
                                                                            <a href="http://www.facebook.com/sharer.php?u=http://www.example.com"
                                                                               target="__blank"><i
                                                                                    class="fab fa-facebook-f"></i></a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="http://twitter.com/share?url=http://www.example.com&text=Simple Share Buttons&hashtags=simplesharebuttons"
                                                                               target="__blank"><i
                                                                                    class="fab fa-twitter"></i></a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.example.com"
                                                                               target="__blank"><i
                                                            ...
                                                            <div class="item-details-tag">
                                                                <ul class="tags-wrapper">
                                                                    ...
                                                                    @foreach($service->tag as $tags)
                                                                        <li>
                                                                            <a href="javascript:void(0)">{{__($tags)}}</a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="product-reviews-content">
                                                            <div class="item-review-widget-wrapper">
                                                                <div class="left">
                                                                    ...
                                                                    <span
                                                                        class="sub-title text-white">{{$service->reviewCount->count()}} @lang('reviews')</span>
                                                                </div>
                                                                <div class="right">
                                                                    <ul class="list">
                                                                        <li>
                                                                        <span class="caption">
                                                                            ...
                                                                            <span
                                                                                class="value">{{__($service->likes)}}</span>
                                                                        </li>
                                                                        <li>
                                                                        <span class="caption">
                                                                            ...
                                                                            <span
                                                                                class="value">{{__($service->dislike)}}</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="rating">
                                                                                ...
                                                                                <input type="radio" id="star2"
                                                                                    ...
                                                                                    for="star2" title="Pretty good">&nbsp;</label>
                                                                                ...
                                                                                <input type="radio" id="star5"
                                                                                    ...
                                                                                    for="star5" title="Sucks big time">&nbsp;</label>
                                                                            </div>
                                                                        ...
                                                                        @foreach($reviews as $review)
                                                                            <li class="comment-container d-flex flex-wrap">
                                                                                <div class="comment-avatar">
                                                                                    <img
                                                                                        src="{{ userDefaultImage(imagePath()['profile']['user']['path'].'/'. $review->user->image,'profile_image') }}"
                                                                                        alt="@lang('client')">
                                                                                </div>
                                                                                <div class="comment-box">
                                                                                    ...
                                                                                    <div class="comment-info mb-1">
                                                                                        <h4 class="avatar-name">{{@$review->user->fullname}}</h4>
                                                                                        - <span
                                                                    ...
                                                                    @if($reviews->total() > 7)
                                                                        <div class="view-more-btn text-center mt-4">
                                                                            <a href="javascript:void(0)"
                                                                               ...
                                                                               data-page="2"
                                                                               data-link="{{route('service.details', [slug($service->title), encrypt($service->id)])}}?page="> @lang('View More')</a>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="comment-form-area mb-40">
                                                                <form class="comment-form" method="POST"
                                                                    ...
                                                                    <input type="hidden" value="{{$service->id}}"
                                                                           name="service_id">
                                                                    <textarea class="form-control h-auto" name="comment"
                                                                              placeholder="@lang('Write Comment')"
                                                                    ...
                                                                    <ul class="comment-list" id="commentShow">
                                                                        @foreach($comments as $comment)
                                                                            <li class="comment-container d-flex flex-wrap">
                                                                                <div class="comment-avatar">
                                                                                    <img
                                                                                        src="{{ userDefaultImage(imagePath()['profile']['user']['path'].'/'. $comment->user->image,'profile_image') }}"
                                                                                        alt="@lang('client')">
                                                                                </div>
                                                                                <div class="comment-box">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="left">
                                                                                            <div class="comment-info">
                                                                                                <h4 class="avatar-name">{{__($comment->user->username)}}</h4>
                                                                                                - <span
                                                                            ...
                                                                            @foreach($comment->commentReply as $replyComment)
                                                                                <li class="comment-container reply-container d-flex flex-wrap">
                                                                                    <div class="comment-avatar">
                                                                                        <img
                                                                                            src="{{ userDefaultImage(imagePath()['profile']['user']['path'].'/'. $replyComment->user->image,'profile_image') }}"
                                                                                            alt="@lang('client')">
                                                                                    </div>
                                                                                    <div class="comment-box">
                                                                                        <div
                                                                                            ...
                                                                                            <div class="left">
                                                                                                <div
                                                                                                    class="comment-info">
                                                                                                    <h4 class="avatar-name">{{__($replyComment->user->username)}}</h4>
                                                                                                    - <span
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="left">
                                                                        <div class="form-group custom-check-group">
                                                                            <label
                                                                                for="level-1">{{__($extra->title)}}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="right">
                                                                        <span
                                                                            class="value">{{__($general->cur_sym)}}{{showAmount($extra->price)}}</span>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                            <div class="service-card-btn">
                                                                <a href="{{route('user.service.booking', [slug($service->title), encrypt($service->id)])}}"
                                                                   class="btn--base">@lang('Order Now')
                                                                    ({{__($general->cur_sym)}}{{showAmount($service->price)}}
                                                                    )</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="widget custom-widget mb-30">
                                                ...
                                                <ul class="details-list">
                                                    <li><span>@lang('Delivery Time')</span>
                                                        <span>{{__($service->delivery_time)}} @lang('Days')</span></li>
                                                ...
                                                <div class="widget-btn mt-20">
                                                    <a href="{{route('user.service.booking', [slug($service->title), encrypt($service->id)])}}"
                                                       class="btn--base w-100">@lang('Order Now')
                                                        ({{$general->cur_sym}}{{showAmount($service->price)}})</a>
                                                </div>
                                            </div>


                                            <div class="widget custom-widget text-center mb-30">
                                                <h3 class="widget-title">@lang('Do you have any special requirements')
                                                    ?</h3>
                                                <div class="widget-btn mt-20">
                                                    @auth
                                                        @if($conversion)
                                                            <a href="{{route('user.conversation.inbox')}}"
                                                               class="btn--base w-100">@lang('Inbox')</a>
                                                        @else
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                               data-bs-target="#depoModal"
                                                               class="btn--base w-100">@lang('Contact Now')</a>
                                                        @endif
                                                    @endauth

                                                    @guest
                                                        <a href="{{route('user.login')}}" data-bs-toggle="modal"
                                                           data-bs-target="#depoModal"
                                                           class="btn--base w-100">@lang('Contact Now')</a>
                                                    @endguest
                                                </div>
                                                ...
                                                <div class="profile-widget">
                                                    <div class="profile-widget-header">
                                                        <div class="profile-widget-thumb">
                                                            <img
                                                                src="{{ userDefaultImage(imagePath()['profile']['user_bg']['path'].'/'. $service->user->bg_image, 'background_image') }}"
                                                                alt="@lang('User image')">
                                                        </div>
                                                        <div class="profile-widget-author">
                                                            <div class="thumb">
                                                                <img
                                                                    src="{{ userDefaultImage(imagePath()['profile']['user']['path'].'/'. $service->user->image,'profile_image') }}"
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <span
                                                                    class="designation">{{__(@$service->user->designation)}}</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="profile-list-area">
                                                        <ul class="details-list">
                                                            <li><span>@lang('Total Service')</span>
                                                                <span>{{__($totalService)}}</span></li>
                                                            <li><span>@lang('In Progress')</span>
                                                                <span>{{$workInprogress}}</span></li>
                                                            <li><span>@lang('Rating')</span> <span> <span
                                                                        class="ratings"><i
                                                                            class="las la-star text--warning"></i></span> ({{getAmount($reviewRataingAvg, 2)}})</span>
                                                            </li>
                                                            <li><span>@lang('Member Since')</span>
                                                                <span>{{showDateTime($service->user->created_at, 'd M Y')}}</span>
                                                            </li>
                                                    ...
                                                    @foreach($otherServices as $other)
                                                        <div class="item-card">
                                                            <div class="item-card-thumb">
                                                                <img
                                                                    src="{{getImage('assets/images/service/'.$other->image, imagePath()['service']['size']) }}"
                                                                ...
                                                                <div class="item-card-content-top">
                                                                    <div class="left">
                                                                        <div class="author-thumb">
                                                                            <img
                                                                                src="{{ userDefaultImage(imagePath()['profile']['user']['path'].'/'. $other->user->image,'profile_image') }}"
                                                                                alt="@lang('author')">
                                                                        </div>
                                                                    ...
                                                                    <div class="right">
                                                                        <div
                                                                            class="item-amount">{{__($general->cur_sym)}}{{showAmount($other->price)}}</div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="right">
                                                                    <div class="order-btn">
                                                                        <a href="{{route('user.service.booking', [slug($other->title), encrypt($other->id)])}}"
                                                                           class="btn--base"><i
                                                                                class="las la-shopping-cart"></i> @lang('Order
                                                                Now')</a>
                                                                    </div>
                                                                </div>
                                                            </div>
