        ...
        <div class="section-wrapper">
            <div class="row justify-content-center mb-30-none">
                ...
                <div class="col-xl-9 col-lg-12 mb-30">
                    ...
                    <form class="user-profile-form" action="{{route('user.service.update', $service->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="card-form-wrapper">
                                    <div class="row justify-content-center">
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    <div class="avatar-preview">
                                                        <div class="profilePicPreview bg_img" data-background="{{getImage('assets/images/service/'.$service->image,'590x300') }}">
                                                        ...
                                                        @foreach($service->optionalImage as $data)
                                                            <div class="d-flex flex-wrap align-items-center justify-content-between optional_img_wrapper mb-20">
                                                                <div class="optional-thumb">
                                                                    <img class="optional_img" src="{{ getImage('assets/images/optionalService/'. $data->image, '590x300') }}">
                                                                </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 form-group">
                                            ...
                                            <input type="text" name="title" maxlength="255" value="{{__($service->title)}}" class="form-control" placeholder="@lang("Enter Title")" required="">
                                        </div>
                                        <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <div class="card custom--card p-0 mb-3">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center addExtraService">
                                                    @if(!empty($service->extraService))
                                                        @foreach($service->extraService as $extrservice)
                                                            <div class="col-lg-12 extraServiceRemove">
                                                                <div class="row">
                                                                <div class="col-xl-9 col-lg-12 form-group">
                                                                    <input type="text" name="extra_title[]" class="form-control" value="{{__($extrservice->title)}}" required>
                                                                </div>

                                                                <div class="col-xl-2 col-lg-12 form-group">
                                                                    <div class="input-group mb-3">
                                                                        <input type="text" class="form-control" name="extra_price[]" value="{{getAmount($extrservice->price)}}" required="">
                                                                      <span class="input-group-text" id="basic-addon2">{{__($general->cur_text)}}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-1">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('user.optional.image') }}">
                ...
                <div class="modal-body">
                    <p>@lang('Are you sure to remove this optional image')</p>
                </div>
