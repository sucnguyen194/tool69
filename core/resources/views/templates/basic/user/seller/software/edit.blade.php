            ...
            <div class="section-wrapper">
                <div class="row justify-content-center mb-30-none">
                    ...
                    <div class="col-xl-9 col-lg-12 mb-30">
                        ...
                        <form class="user-profile-form" action="{{route('user.software.update', $software->id)}}"
                                        ...
                                        <div class="row justify-content-center">
                                                    ...
                                                    <div class="thumb">
                                                        <div class="avatar-preview">
                                                            <div class="profilePicPreview bg_img"
                                                                 data-background="{{getImage('assets/images/software/'.$software->image,'590x300') }}">
                                                        ...
                                                        <div class="avatar-edit">
                                                            ...
                                                            <label for="profilePicUpload2"
                                                                   class="text-light">@lang('Image')</label>
                                                            <small>@lang('Supported files'): @lang('jpeg'), @lang('jpg')
                                                                , @lang('png')
                                                                . @lang('Image will be resized into 590x300 px')</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                <div class="card custom--card p-0 mb-3">
                                                    <div
                                                        ...
                                                        <div class="card-btn">
                                                            <button type="button" class="btn--base addExtraImage"><i
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="optional-thumb">
                                                                        <img class="optional_img"
                                                                             src="{{ getImage('assets/images/screenshot/'. $data->image, '590x300') }}">
                                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 form-group">
                                                ...
                                                <input type="text" name="title" maxlength="255"
                                                       value="{{__($software->title)}}" class="form-control"
                                                       required="">
                                            </div>
                                            <div class="col-xl-6 col-lg-6 form-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                ...
                                                <select name="subcategory" class="form-control mySubCatgry"
                                                        id="subCategorys">
