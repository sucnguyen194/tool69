                    ...
                    <div class="card custom--card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                              ...
                              <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Delivery Date')
                                <span>{{showDateTime($booking->created_at->addDays($booking->biding->job->delivery_time), ('d M Y'))}}</span>
                              </li>
                            ...
                            @if($booking->workFile->isNotEmpty())
                                ...
                                <h4 class="text-center">@lang('Work Delivery')</h4>
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <p>{{__($file->details)}}</p>
                                        <a href="{{route('user.work.delivery.download', encrypt($file->id))}}" class="btn btn--primary btn-rounded text-white">@lang('File Download')</a>
                                    </div>
                                    @endforeach
                                </div>
                            @endif
