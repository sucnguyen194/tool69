                            ...
                            <tr>
                                <td data-label="@lang('Name')">
                                    @if ($advr->type == 1)
                                        <div class="user">
                                            <div class="thumb">
                                                <a href="{{getImage(imagePath()['advertisement']['path'].'/'. $advr->adimage,$advr->size)}}" target="__blank">
                                                    <img src="{{getImage(imagePath()['advertisement']['path'].'/'. $advr->adimage,$advr->size)}}" alt="@lang('image')">
                                                </a>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" name="name" placeholder="@lang("Enter Name")" required value="{{old('name')}}" id="name" maxlength="40">
                </div>
...
@push('breadcrumb-plugins')
    <button type="button" data-toggle="modal" data-target="#adModal" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-plus"></i>@lang('Add New')</button>
@endpush
