                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr @if($loop->odd) class="table-light" @endif>
                                ...
                                <td data-label="@lang('Employees')">
                                    <span class="font-weight-bold">{{$booking->biding->user->fullname}}</span>
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.users.detail', $booking->biding->user_id) }}"><span>@</span>{{ $booking->biding->user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Delivery Date')">
                                    <span class="font-weight-bold">{{showDateTime($booking->created_at->addDays($booking->biding->job->delivery_time), ('d M Y'))}}</span>
                                    <br>
                                    {{diffforhumans($booking->created_at->addDays($booking->biding->job->delivery_time))}}
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{route('admin.hire.details', $booking->id)}}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.hire.search', $scope ?? str_replace('admin.hire.', '', request()->route()->getName())) }}" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
            <input type="text" name="search" class="form-control" placeholder="@lang('Employees / Buyer')" value="{{ $search ?? '' }}">
